...
<section class="container">
    <h4 class="center">Submit beauty salon</h4>
    ...
    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" class="white form" method="POST">
        ...
        <label for="type">Type of salon:</label>
        ...
        <div class="center">
            <input type="submit" name="add" value="Post a Salon" class="btn purple darken-2 z-depth-0">
        </div>
    </form>
